...
In this initial project of the networking series, I completed a set of quiz questions and created
some Bash scripts to explore fundamental concepts in networking. Through this project, I gained
knowledge on topics such as the OSI model, LAN and WAN networks, and TCP/UDP protocols for
transferring data.
